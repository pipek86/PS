...
$URI       = 'C:\PS\azure\active-directory-new-domain-with-data\azuredeploy.json'
$Location  = 'East US'
$rgname    = 'goateerg'
$saname    = 'goateesa'     # Lowercase required
$addnsName = 'goateead'     # Lowercase required
...
$MyParams = @{
    ...
    adminUsername         = "mpipala"
   }

# Splat the parameters on New-AzureRmResourceGroupDeployment   adVMName              = "DC1"
$SplatParams = @{
    TemplateUri             = $URI 
